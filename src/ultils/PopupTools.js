(function(f) {
   ...
   * @return {Object}
   */
  function popupExecute(execute, url, name, options, callback, fromFacebook) {
    var popupName = name || defaultPopupName();
    var popupOptions = optionsResolveCentered(
   ...
   * @return {Object}
   */
  function popup(url, name, options, callback, fromFacebook) {
    return popupExecute(
      window.open,
      url,
      name,
